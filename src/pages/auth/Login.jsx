    ...
    <div className="min-h-screen flex bg-white dark:bg-zinc-950">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-950 dark:bg-zinc-900 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            <blockquote className="text-white/90 text-2xl font-light leading-relaxed mb-6" style={{ fontFamily: 'Instrument Serif, serif' }}>
              "The best shopping experience, curated just for you."
            </blockquote>
            <div className="flex items-center gap-3">
              <img src="https://i.pravatar.cc/40?img=44" className="w-10 h-10 rounded-full ring-2 ring-white/20" alt="" />
              <div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              ...
              required
              icon={<svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>}
            />
            <Input
              label="Password"
              ...
              required
              iconRight={
                <button type="button" onClick={() => setShowPass(!showPass)} className="text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 transition-colors">
            ...
            <div className="flex justify-end">
              <Link to="/auth/forgot-password" className="text-xs font-semibold text-primary-600 hover:text-primary-700 transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-zinc-500 mt-6">
            ...
            <Link to="/auth/register" className="text-primary-600 hover:text-primary-700 font-semibold transition-colors">
              Create one
            </Link>
          </p>
        </div>
