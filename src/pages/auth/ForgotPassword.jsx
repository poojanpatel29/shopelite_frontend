        ...
        <div className="card p-8">
          {sent ? (
            <div className="text-center space-y-4 py-4">
              ...
              <Link
                to="/auth/login"
                className="inline-flex items-center gap-1.5 text-primary-600 font-semibold text-sm hover:text-primary-700 transition-colors mt-2"
              >
                ← Back to Sign In
              </Link>
            </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Link
                  to="/auth/login"
                  className="block text-center text-sm text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300 transition-colors"
                >
                  ← Back to Sign In
                </Link>
              </form>
