...
export default function Home() {
  ...
  const deals = useMemo(() =>
    all.filter((p) => p.discount > 0).slice(0, 4),
    [all]
  )
      ...
      {deals.length > 0 && (
        <section className="bg-gradient-to-r from-accent to-red-500 text-white py-12 mb-12">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <Link to="/products?filter=deals" className="bg-white text-accent hover:bg-gray-50 font-semibold px-8 py-3 rounded-xl transition-colors inline-block">
              Grab the Deals →
            </Link>
          </div>
        </section>
