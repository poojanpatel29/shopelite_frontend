...
export default function Analytics() {
  ...
  const [orderStatus, setOrderStatus] = useState({ delivered: 0, shipped: 0, processing: 0, pending: 0, cancelled: 0 })
  ...
  useEffect(() => {
    Promise.all([
      ...
      const cats = { electronics: 0, clothing: 0, books: 0, 'home-garden': 0, sports: 0, beauty: 0 }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card p-6">
          ...
          {loading
            ? <div className="flex justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-2 border-gray-200 border-t-primary-600" /></div>
