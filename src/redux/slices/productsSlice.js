...
export const {
  setProducts, setTotal, setLoading, setError,
  setSelected, addProduct, updateProduct, deleteProduct,
...
export const selectProductById      = (id) => (state) => state.products.items.find((p) => p.id === Number(id))
